...
public class CinemaInitServiceImpl implements ICinemaInitService{
	...
	public void initCinemas() {
		villeRepository.findAll().forEach(v->{
		 Stream.of("Megarama","Imax","Founoun","Chahrazad","Dawliz").forEach(nameCinema->{
	...
	public void initSeances() {
		...
		Stream.of("12:00","15:00","17:00","19:00","22:00","01:00").forEach(s->{
	...
	public void initCategories() {
		Stream.of("Action","Drama","Thriller").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("The pursuit of happiness","intouchable","cast away","The equalizer").forEach(titreFilm->{
			Film film = new Film();
